...
bool CreateCopyDelete::copyDirectory(std::wstring* fromDir, std::wstring* toDir) const
{
	HANDLE hSearch;
...
bool CreateCopyDelete::deleteDirectory(std::wstring* dir) const
{
	HANDLE hSearch;
	WIN32_FIND_DATA itemData;
	std::wstring searchFilter;
...
bool CreateCopyDelete::getDirectorySize(std::wstring* dir, uint32_t* directorySize) const
{
	HANDLE hSearch;
	WIN32_FIND_DATA itemData;
	std::wstring searchFilter;
